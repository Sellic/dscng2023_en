...
<div class="lat main-board">
    ...
    <?php for ($i=0; $i<$list_count; $i++) {  ?>
        <li class="basic_li">
            ...
            if ($list[$i]['is_notice']) {
                echo "<span class='article_title'>".$list[$i]['subject']."</span><span class='article_date'>".$list[$i]['datetime']."</span>";
            } else {
                echo "<span class='article_title'>" . $list[$i]['subject'] . "</span><span class='article_date'>" . $list[$i]['datetime'] . "</span>";
            }
            ...
            ?>
            <div class="contents">
				<!-- <span class="lt_content"><?php echo $list[$i]['wr_content'] ?></span> -->
