            ...
            <table>
                ...
                <thead class="sm-hidden">
                    <tr>
                        ...
                        <?php } ?>
                        <th scope="col" class="sm-hidden">No.</th>
                        <th scope="col">Subject</th>
                        <th scope="col" class="sm-hidden">Name</th>
                        <th scope="col" class="sm-hidden"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>Views </a></th>
                        <?php if ($is_good) { ?><th scope="col"><?php echo subject_sort_link('wr_good', $qstr2, 1) ?>추천 </a></th><?php } ?>
                        <?php if ($is_nogood) { ?><th scope="col"><?php echo subject_sort_link('wr_nogood', $qstr2, 1) ?>비추천 </a></th><?php } ?>
                        <th scope="col" class="sm-hidden"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>Date </a></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    ?>
                        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
                            ...
                            <td class="td_name sm-hidden"><?php echo $list[$i]['name'] ?></td>
                            <td class="td_num sm-hidden"><?php echo $list[$i]['wr_hit'] ?></td>
                            <?php if ($is_good) { ?><td class="td_num"><?php echo $list[$i]['wr_good'] ?></td><?php } ?>
                            <?php if ($is_nogood) { ?><td class="td_num"><?php echo $list[$i]['wr_nogood'] ?></td><?php } ?>
                            <td class="td_datetime sm-hidden"><?php echo $list[$i]['datetime'] ?></td>

                        </tr>
                    <?php } ?>
                    <?php if (count($list) == 0) {
                        echo '<tr><td colspan="' . $colspan . '" class="empty_table">No Contents.</td></tr>';
                    } ?>
                </tbody>
            </table>
        </div>
