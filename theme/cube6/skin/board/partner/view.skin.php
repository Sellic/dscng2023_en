...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <div id="bo_v_top">
            ...
            <ul class="btn_bo_user bo_v_com">
                ...
                <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="글쓰기">새글쓰기</a></li><?php } ?>
    ...
    <section id="bo_v_profile">
        <span class="profile">이메일 : <?php echo $view['wr_email'] ?></span>
        <span class="profile">연락처 : <?php echo $view['wr_homepage'] ?></span>
        <span class="profile">회사명 : <?php echo $view['wr_1'] ?></span>
    </section>
    ...
    <!-- <div class="listbtn text-center">
        <a href="/bbs/write.php?bo_table=partner" class="" title="추가문의">추가문의</a>
    </div> -->
